    ...
    <div className="flex flex-row items-end relative">
      {activeTab === "Agendamentos" ? (
        ...
        >
          ...
          <div className="w-[1.5rem] h-[1.5rem] right-[-1.5rem] bottom-[0.75rem] rounded-full bg-background z-20 absolute" />
        </h2>
      ) : (
        <h2
          onClick={() => setActiveTab("Agendamentos")}
          className={`mb-0 px-5 pb-2 font-semibold text-lg text-center bg-background rounded-t-xl z-50 relative cursor-pointer`}
        >
          Agendamentos
        </h2>
      )}
      ...
      {activeTab === "Emprestimos" ? (
        ...
        >
          Empréstimos
          <div className="w-[1.5rem] h-[1.5rem] left-[-1.5rem] bottom-0 rounded-full bg-background z-20 absolute" />
          ...
          <div className="w-[1.5rem] h-[1.5rem] right-[-1.5rem] bottom-0 rounded-full bg-background z-20 absolute" />
        </h2>
      ) : (
        <h2
          onClick={() => setActiveTab("Emprestimos")}
          className={`mb-0 ml-[0.5rem] px-5 pb-2 font-semibold text-lg text-center bg-background rounded-t-xl z-50 relative cursor-pointer `}
        >
          Empréstimos
        </h2>
      )}
